 ...
 * @author momog
 */
public class ServicoExpansivel implements Servicos {
     ...
     */
    public ServicoExpansivel(int id, String dBreve, String dCompl, double custoHora) {
        this.id = id;
        this.dBreve = dBreve;
    ...
    public String toString() {
        return "ServicoExpansivel{" + "id=" + id + ", descBreve=" + dBreve + ", descCompl=" + dCompleta + ", custoHora=" + custoHora + '}';
    }
